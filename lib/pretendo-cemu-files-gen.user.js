...
// @require      https://raw.githubusercontent.com/pwasystem/zip/d0bbf615/zip.js
...
(function () {
    ...
    function nameToHex(nameStr) {
        ...
        // Encode the input string to UTF-16LE
        const utf16Encoder = new TextEncoder('utf-16le');
        const encoded = utf16Encoder.encode(nameStr);

        // Swap the endianness of each 16-bit unit
        ...
        buffer.set(swapped.slice(0, 0x16));
